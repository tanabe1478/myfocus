...
- **AIアシスタント**: [Pi coding agent](https://pi.dev/) をRPCモードで組み込み。読んでいる記事についての相談、ローカル記事アーカイブの横断検索、スター・既読傾向と「興味あり／なし」に基づく未読記事の推薦、新しい記事・フィードの探索ができる。推薦は12時間キャッシュされ、提案された記事やフィードはワンクリックで開ける
